...
public class Autostrada {
     ...
     * @param tariffe
     */
    public void addTariffe( List<Float> listaTariffe ) {
	    addTariffa("A", listaTariffe.get(0));
	    addTariffa("B", listaTariffe.get(1));
	    addTariffa("3", listaTariffe.get(2));
	    addTariffa("4", listaTariffe.get(3));
	    addTariffa("5", listaTariffe.get(4));
    }
    /**
     * 
     * @param classeVeicolo
